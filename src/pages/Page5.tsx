        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12 animate-fade-in">
            ...
            <p className="text-xl text-gray-600">
              Giá trị bất hủ của đường lối thống nhất
            </p>
          </div>
          ...
          <div className="space-y-6 animate-slide-up">
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-3">
                    ...
                    , cùng chung một mục tiêu là giải phóng và thống nhất Tổ
                    quốc.
                  </p>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    <span className="font-semibold">Miền Bắc</span> xây dựng hậu
                    phương vững chắc, chi viện sức người sức của cho miền Nam.
                    <span className="font-semibold"> Miền Nam</span> kiên cường
                    đấu tranh, góp phần quan trọng vào thắng lợi chung.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-100 to-red-100 rounded-2xl p-8 shadow-2xl border-l-8 border-blue-700">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h2 className="text-2xl font-bold text-[#0a3d62] mb-4 flex items-center gap-2">
                    <Flag className="text-red-600" size={28} />Ý nghĩa lịch sử
                    sâu sắc
                  </h2>
                  <p className="text-lg text-gray-700 leading-relaxed mb-3">
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Thắng lợi này khẳng định sức mạnh to lớn của dân tộc Việt
                    Nam, tinh thần yêu nước và ý chí quyết tâm thống nhất Tổ
                    quốc.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed mb-3">
                    ...
                    , sự lãnh đạo sáng suốt của Đảng là những nhân tố quyết định
                    đến thắng lợi.
                  </p>
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Đây là bài học quý báu cho công cuộc{" "}
